...
export const metadata = { title: 'תקנון שימוש | ScentAI' };
      ...
      <article className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-ink-secondary text-sm font-hebrew leading-relaxed">
          <section>
            ...
            <p>השימוש באתר ScentAI כפוף לתנאי השימוש המפורטים להלן. גלישה ושימוש באתר מהווים הסכמה לתנאים אלה.</p>
          </section>

          <section>
            <h2 className="font-serif text-lg text-ink font-semibold mb-2">2. השירות</h2>
            <p>ScentAI הוא שירות מנוי לבשמי נישה מבוסס AI. השירות כולל המלצות אישיות, דגימות חודשיות, גישה לקטלוג בשמים וכלים נלווים.</p>
          </section>
          ...
          <section>
            ...
            <p>ניתן לבקש החזר תוך 30 יום מתאריך החיוב הראשון. בקשות החזר יש להפנות לכתובת contact@scentai.co.il.</p>
          </section>
          ...
          <section>
            ...
            <p>שאלות ופניות: <a href="mailto:contact@scentai.co.il" className="text-gold hover:underline" dir="ltr">contact@scentai.co.il</a></p>
          </section>
        </div>
      </article>
    </main>
